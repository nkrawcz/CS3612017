...
// We are essentially writing out the sentential as Java code.
// Look at the steps for the algorithm and use the existing code to define each thing.	
	
	private Assignment assignment() { // 1
		// Assignment --> Identifier = Expression ; (THIS IS THE SENTENTIAL)
		Assignment a = new Assignment(); // 2
		if (token.getType().equals("Identifier")) {
			...
			throw new RuntimeException(SyntaxError("Identifier")); // 3b.
		return a;
	}
